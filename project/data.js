				...
				"choices": [
					...
					},
					{
						...
						"action": [
							...
							"\f[benson.jpg,90,50]本森级是二战时期美国的一型驱逐舰，1938年开工，共建造32艘并参与战争。本森级配备了5门127mm炮，2座五联装鱼雷发射管，8门防空武器和深水炸弹，最高航速37.5节。本森级驱逐舰中最著名的一艘是被称为“所罗门疯狗”的拉菲号，在瓜岛与日军的夜间海战中，拉菲号顶着凶猛的炮火，勇敢地向日本战列舰比睿号冲锋并发射鱼雷，随后在极近距离下用一切能用的武器猛扫日军甲板，最终遭到围攻而沉没。",
					...
					},
					{
						...
						"action": [
							...
							"\f[warspite.jpg,90,50]装备属性：攻+500。闪避鱼雷数-1。\n被动：\n主炮轰击：每3回合额外发射一轮主炮，对敌方水面战舰造成3倍攻击力的伤害。",
							{
								"type": "confirm",
								"text": "确定购买？",
								"yes": [
					...
					},
					{
						...
						"action": [
							...
							"\f[hurricanemk2.png,90,50]装备属性：攻+100。攻击对象为轰炸机或装甲小于20的坦克时，每回合普攻伤害额外增加10%",
							{
								"type": "confirm",
								"text": "确定购买？",
								"yes": [
					...
					},
					{
						...
						"action": [
							...
							"\f[f4f.jpg,90,50]装备属性：攻+80后额外加10%。挂载：2×100磅炸弹。与敌方空军作战时，每个偶数回合普攻伤害增加15%\n仅第2回合投弹，造成两次0.4倍攻击力的伤害。",
							{
								"type": "confirm",
								"text": "确定购买？",
								"yes": [
				...
				"choices": [
					...
					},
					{
						...
						"action": [
							...
							"\f[matilda.jpg,90,50]装备属性：攻+50，穿50，装75。\n被动技能：\n迟缓：未击穿敌方装甲时，敌人额外先攻5回合。",
							{
								"type": "confirm",
								"text": "确定购买？",
								"yes": [

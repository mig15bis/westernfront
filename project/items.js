var items_296f5d02_12fd_4166_a7c1_b5e830c9ee3a = 
{
	...
	"f4f3": {
		...
		"name": "F4F-3野猫",
		"canUseItemEffect": "true",
		"text": "装备属性：攻+80后额外加10%。仅第2回合投弹，造成两次0.4倍攻击力的伤害。\n被动：\n萨奇剪刀：与敌方战斗机作战时，以受到伤害增加5%为代价，使普攻伤害+20%。",
		"equip": {
			"type": 4,
			"value": {
				"atk": 80
	...
	"cola": {
		...
		"useItemEffect": "let hpmax = core.getRealStatus('hpmax');\nif (hero.hp > hpmax * 1 / 2 && !core.getFlag(\"__statistics__\")) core.drawHeroAnimate('hpfull');\ncore.status.hero.hp += hpmax * 0.5;"
	},
	"I520": {
		"cls": "items",
		"name": "银屑",
	...
	"I667": {
		...
		"name": "演讲稿",
		"canUseItemEffect": "true",
		"text": "语言的力量！\n使用后清空所有“惊慌”层数，并获得“振奋”状态：攻击力提升10%，持续一场战斗（不可叠加）。",
		"useItemEvent": [
			{
				"type": "setValue",
				"name": "flag:scare",
	...
	"is3": {
		...
		"name": "IS-3“斯大林”重型坦克",
		"canUseItemEffect": "true",
		"text": "攻击+5000后额外+300%，穿215装240。\n被动：\n钢铁洪流：生命值大于50%时，攻击力进一步提高40%。\n装甲扫荡：对一切地面目标伤害提升50%，受到战斗伤害减少30%。无视万岁冲锋。\n乌拉：不会被惊慌debuff影响。",
		"equip": {
			"type": 0,
			"value": {
				"atk": 5000,
	...
	"tu4": {
		...
		"name": "图波列夫 TU-4轰炸机",
		"canUseItemEffect": "true",
		"text": "自卫武器：10×12.7mm机枪和1×23mm机炮。挂载：18×1000磅炸弹。\n被动：\n山寨版B29：技能组和属性加成同B29轰炸机。",
		"equip": {
			"type": 6,
			"value": {},
			"percentage": {}

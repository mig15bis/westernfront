var items_296f5d02_12fd_4166_a7c1_b5e830c9ee3a = 
{
	...
	"f4u": {
		...
		"name": "F4U-4B海盗",
		"canUseItemEffect": "true",
		"text": "主武器：4×20mm机炮。挂载：8×HVAR火箭弹和2×1000磅炸弹\n属性：攻击+n后额外加100%。与陆军和海军作战时抢先发射2轮火箭弹，每枚火箭弹伤害为0.2倍攻击力（对步、炮和小型舰艇增伤15%）。仅第2回合投弹，每颗炸弹伤害为4倍攻击力。\n被动：\n死亡口哨：战斗开始前，削减敌人20%血量和攻击力。\n空域肃清：已夺取制空权时，我军一切空袭伤害提高50%。未夺取制空权时，对战斗机伤害提升20%。"
	},
	"p51d": {
		"cls": "equips",
		"name": "P51D野马",
		"canUseItemEffect": "true",
		"text": "主武器：6×12.7mm机枪。挂载：10×HVAR火箭弹\n属性：攻击+n后额外加100%。与陆军和水面舰艇战斗时抢先发射2轮火箭弹，每枚火箭弹伤害为0.2倍攻击力（对步、炮和小型舰艇增伤25%）。\n被动：\n长途护航：受到的所有战斗伤害减少30%。且受到敌空军的回合伤害不会超过10%血限。\n制空霸权：与敌方空军战斗时，战斗方式改为3连击。对喷气机不生效。已夺取制空权时，我军一切空袭伤害提高60%。"
	},
	"skua": {
		"cls": "equips",
		"name": "贼鸥式轰炸机",

main.floors.MT385=
{
    ...
    "firstArrive": [
        ...
        {
            "type": "text",
            "text": "\t[巴顿]\f[patton.png,0,310]巴斯托涅的守军，我的装甲军团会尽一切可能的为你们解围，在那之前请一定坚持住！",
            "pos": [
                100,
                300,
                380
    ...
    "events": {
        "13,6": [
            {
                "type": "text",
                "text": "\t[伊吹萃香]\f[specialnpc.jpg,0,280,100,200]突击虎的380毫米口径大炮，一发就能干掉你大半管血，但装填速度是相当慢的。要想以最小的损失摧毁它们，最好的方法就是别让它们开出第二炮！",
                "pos": [
                    100,
                    280,
                    380
    ...
    "cannotMoveIn": {},
    "map": [
    [639,642,641,  0,160,518,518,518,160, 21, 21,160,641,640,641],
    [160,160,160,665,160,160,228,160,160,247,247,160,279,270,  0],
    [524,  0,160,  0,275, 21,  0,228, 81,275,  0,160,160, 81,160],
    [524,270, 81,  0,160,  0,279,  0,160,  0, 21,  0,664,644,  0],
    [524,  0,160,228,160,160,160,160,160,160,  0,279,160,  0,644],
    [160,160,160,  0,275,  0,640,160,640,160,228,160,160,160,160],
    [518,160,  0,270,  0,275,664, 81,279,160,  0,640,160,601,609],
    [518,160,  0,279,160,160,160,279,  0,160,275,  0, 82,  0, 94],
    [270, 81,228,160,160,160, 22,  0,664, 81,  0,275,160,  0,609],
    [641,160,  0,644,160,160,270,160,160,160,  0, 21,160,160,160],
    [160,160,160,  0,669,  0,  0,279,160,160, 21,  0,160, 21, 22],
    [664, 89,160, 81,160,160,228,644,160,160,160,228, 81,275, 21],
    [412,664,160,665,160,279,  0,228,160,279,  0,  0,160,160,160],
    [ 82,160,160,  0,160, 82,160,160,160,160, 81,160,160,639, 22],
    [275,  0,228,  0,160,666,642,642,642,160,  0,412,  0,639,639]
],
    "bgmap": [

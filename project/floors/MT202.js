main.floors.MT202=
{
    ...
    "events": {
        ...
        "8,2": [
            {
                "type": "text",
                "text": "\t[伊吹萃香]\f[specialnpc.jpg,0,280,100,200]登陆战的地点一般位于浅滩，并且可以获得海军的支援。可一旦深入内陆，海军装备就会撤退，不再提供支援。海军的很多技能虽然不会在登陆战中生效，但光是提供的基础数值加成就相当可观了，所以在深入内陆之前建议把海滩上的敌人清理一下哦！",
                "pos": [
                    100,
                    280,
                    380
            ...
            {
                "type": "text",
                "text": "\t[伊吹萃香]\f[specialnpc.jpg,0,280,100,200]除此之外，从现在开始，美国军队加入战局，还带来了一种新的物资，名叫\r[yellow]可乐\\i[cola]\r。这种东西虽然数量比较少，但一瓶就可以提供50%的生命回复和大量的临时后勤值，在战场上看见了就不要放过哦！",
                "pos": [
                    100,
                    280,
                    380

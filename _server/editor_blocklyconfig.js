...
(function(){
  ...
  var toolboxObj = {
    ...
    "任务相关":[
      MotaActionFunctions.actionParser.parseList({"type":"setTask","name":"mission name","n":"1","text":"任务描述","info":[
      ...
      {"type":"checkFlag","checkFlag":"flag1","operator":"=","count":"\"value\""},
        {"type":"checkBlock","checkBlock":"ju87b","floorId":["MT1","MT2"],"operator":"<=","count":0},
        {"type":"checkEnemyType","checkEnemyType":"战斗机","floorId":["MT1","MT2"],"operator":"<=","count":0},
    ...
    '特效表现':[
      ...
      MotaActionBlocks['showui_s'].xmlText(),
      MotaActionBlocks['hideui_s'].xmlText(),
